...
class GetBearerTokenDetailsResponse(BaseModel):
    """
    GetBearerTokenDetailsResponse
    """ # noqa: E501
    token: DetailedBearerTokenInfo
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": DetailedBearerTokenInfo.from_dict(obj["token"]) if obj.get("token") is not None else None
        })
        return _obj
