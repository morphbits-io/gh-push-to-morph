...
class UserManagementRequest(BaseModel):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="User wallet file.")
    role: UserRole
    super_key: Optional[StrictStr] = Field(default=None, description="Superkey wallet file.", alias="superKey")
    __properties: ClassVar[List[str]] = ["key", "role", "superKey"]
