...
class S3GetAccessTokensResponse(BaseModel):
    """
    S3GetAccessTokensResponse
    """ # noqa: E501
    tokens: List[S3TokenInfo] = Field(description="Tokens list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tokens": [S3TokenInfo.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None
        })
        return _obj
