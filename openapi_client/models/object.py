...
class Object(BaseModel):
    ...
    path: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Object file path.")
    ...
    __properties: ClassVar[List[str]] = ["oid", "path", "creationDate", "size", "contentType", "lifetime"]
