...
class GetUserMetricsResponse(BaseModel):
    """
    GetUserMetricsResponse
    """ # noqa: E501
    bucket_count: StrictInt = Field(description="Total number of buckets owned by the user.", alias="bucketCount")
    used_space: StrictInt = Field(description="Used space by user in bytes.", alias="usedSpace")
    __properties: ClassVar[List[str]] = ["bucketCount", "usedSpace"]
