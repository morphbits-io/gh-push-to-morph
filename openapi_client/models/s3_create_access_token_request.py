...
class S3CreateAccessTokenRequest(BaseModel):
    """
    ...
    read: Optional[StrictBool] = Field(default=True, description="Flag allowing to read objects with this token.")
    modify: Optional[StrictBool] = Field(default=True, description="Flag allowing to create and delete objects with this token.")
    manage_settings: Optional[StrictBool] = Field(default=True, description="Flag allowing to manage S3 bucket cors, tags, notifications, policy, ownerships and locks with this token.", alias="manageSettings")
    __properties: ClassVar[List[str]] = ["ttl", "createBucket", "deleteBucket", "setBucketEACL", "bucketName", "tokenName", "read", "modify", "manageSettings"]
