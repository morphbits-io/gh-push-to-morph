...
class CreateBucketTransferRequest(BaseModel):
    """
    CreateBucketTransferRequest
    """ # noqa: E501
    recipient_login: StrictStr = Field(description="Recipient user login.", alias="recipientLogin")
    __properties: ClassVar[List[str]] = ["recipientLogin"]
