...
class SignedSessionToken(BaseModel):
    """
    SignedSessionToken
    """ # noqa: E501
    payload: StrictStr = Field(description="This payload should be signed by client.")
    verb: SessionVerb
    signature: StrictStr = Field(description="Signature for the payload.")
    __properties: ClassVar[List[str]] = ["payload", "verb", "signature"]
