...
class S3GetAccessTokenDetailsResponse(BaseModel):
    """
    S3GetAccessTokenDetailsResponse
    """ # noqa: E501
    token: S3DetailedTokenInfo
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": S3DetailedTokenInfo.from_dict(obj["token"]) if obj.get("token") is not None else None
        })
        return _obj
