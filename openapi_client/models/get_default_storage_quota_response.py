...
class GetDefaultStorageQuotaResponse(BaseModel):
    """
    GetDefaultStorageQuotaResponse
    """ # noqa: E501
    default_quota: StrictInt = Field(description="Default storage quota for users in bytes.", alias="defaultQuota")
    __properties: ClassVar[List[str]] = ["defaultQuota"]
