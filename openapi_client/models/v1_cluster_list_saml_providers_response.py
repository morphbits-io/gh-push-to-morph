...
class V1ClusterListSAMLProvidersResponse(BaseModel):
    """
    V1ClusterListSAMLProvidersResponse
    """ # noqa: E501
    providers: List[SAMLProviderRecord]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [SAMLProviderRecord.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
