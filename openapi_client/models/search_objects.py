...
class SearchObjects(BaseModel):
    ...
    attributes: Dict[str, Any] = Field(description="Requested attributes. The first filter key will also be added as an additional attribute in the response, if that attribute wasn't explicitly requested.")
    __properties: ClassVar[List[str]] = ["objectId", "attributes"]
