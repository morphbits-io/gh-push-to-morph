...
class V1GetSystemStoragePoliciesResponse(BaseModel):
    """
    V1GetSystemStoragePoliciesResponse
    """ # noqa: E501
    policies: List[NamedStoragePolicy] = Field(description="Storage policy list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [NamedStoragePolicy.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
