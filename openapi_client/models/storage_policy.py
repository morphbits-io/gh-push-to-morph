...
class StoragePolicy(BaseModel):
    ...
    selectors: List[Selector] = Field(description="Set of Selectors to form the bucket's nodes subset.")
    filters: List[PlacementFilter] = Field(description="List of named filters to reference in selectors.")
    __properties: ClassVar[List[str]] = ["replicas", "placementFactor", "selectors", "filters"]
