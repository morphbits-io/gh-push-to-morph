...
class GetBearerTokensResponse(BaseModel):
    """
    GetBearerTokensResponse
    """ # noqa: E501
    tokens: List[BearerTokenInfo] = Field(description="Bearer tokens list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tokens": [BearerTokenInfo.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None
        })
        return _obj
