...
class V1InitialRegistrationRequest(BaseModel):
    """
    V1InitialRegistrationRequest
    """ # noqa: E501
    login: StrictStr = Field(description="Account login.")
    password: StrictStr = Field(description="Account password.")
    __properties: ClassVar[List[str]] = ["login", "password"]
