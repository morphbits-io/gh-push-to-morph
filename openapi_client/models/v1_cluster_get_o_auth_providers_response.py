...
class V1ClusterGetOAuthProvidersResponse(BaseModel):
    """
    V1ClusterGetOAuthProvidersResponse
    """ # noqa: E501
    providers: List[OAuthProviderRecord]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "providers": [OAuthProviderRecord.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
        return _obj
